...
CREATE TABLE `tb_profess` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='InnoDB free: 103424 kB';

-- ----------------------------
-- Records of tb_profess
-- ----------------------------
INSERT INTO tb_profess VALUES ('1', '2', '商务管理', 'Shang Wu Guan Li', '2012-03-26 00:02:25', '2012-03-26 00:04:39');
INSERT INTO tb_profess VALUES ('2', '1', '计算机网络2', 'Ji Suan Ji Wang Luo 2', '2012-03-26 00:08:46', '2012-03-26 00:10:53');
INSERT INTO tb_profess VALUES ('3', '1', '商务会计', 'Shang Wu Kuai Ji', '2012-03-26 00:09:45', null);
...
-- ----------------------------
INSERT INTO tb_project VALUES ('1', '预本硕连读项目', 'Yu Ben Shuo Shi LIan Du Xiang Mu', null, '2012-03-21 23:20:02', null);
INSERT INTO tb_project VALUES ('2', '法国兰斯管理学院本硕连读项目', 'Fa Guo Lan Si Guan Li Xue Yuan Ben Shuo Lian Du Xiang Mu', null, '2012-03-21 23:36:59', null);
INSERT INTO tb_project VALUES ('4', '英国南安普顿大学艺术设计本科项目', 'Ying Guo Nan An Du Da Xue Yi Shu She Ji Ben Ke Xiang Mu', null, '2012-03-21 23:39:32', '2012-03-21 23:39:42');
