...
//      actionNames.add( ClassUtils.getSimpleName(actionClass) ); // delete by chiknin
    	actionNames.add(api.getApiNamespace().replace('.', '_') + '_' + ClassUtils.getSimpleName(actionClass)); // add by chiknin
    }
