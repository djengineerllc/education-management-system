...
public final class JsonPrimitive extends JsonElement {
  ...
  public Boolean getAsBoolean() {
    if (isBoolean()) {
      ...
      return StringUtils.isNotBlank(v) ? Boolean.valueOf(getAsString()) : null;
    }
  }
  ...
  public Double getAsDouble() {
    if (isNumber()) {
      ...
      String v = getAsString();
      return StringUtils.isNotBlank(v) ? Double.valueOf(getAsString()) : null;
    }
  }
  ...
  public Float getAsFloat() {
    if (isNumber()) {
      ...
      String v = getAsString();
      return StringUtils.isNotBlank(v) ? Float.valueOf(getAsString()) : null;
    }
  }
  ...
  public Long getAsLong() {
    if (isNumber()) {
      ...
      String v = getAsString();
      return StringUtils.isNotBlank(v) ? Long.valueOf(getAsString()) : null;
    }
  }
  ...
  public Short getAsShort() {
    if (isNumber()) {
      ...
      String v = getAsString();
      return StringUtils.isNotBlank(v) ? Short.valueOf(getAsString()) : null;
    }
  }
  ...
  */
  ...
  public Integer getAsInt() {
    if (isNumber()) {
      ...
      String v = getAsString();
      return StringUtils.isNotBlank(v) ? Integer.valueOf(getAsString()) : null;
    }
  }
  ...
  public Byte getAsByte() {
    if (isNumber()) {
      ...
      String v = getAsString();
      return StringUtils.isNotBlank(v) ? Byte.valueOf(getAsString()) : null;
    }
  }
  ...
  public Character getAsCharacter() {
	String v = getAsString();
    return (StringUtils.isNotBlank(v) && v.length() > 0) ? v.charAt(0) : null;
  }
